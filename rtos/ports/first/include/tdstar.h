...
typedef struct {
  int command;
  void *param;
} TDSTAR_command_message;

/* flags... */
#define TDSTAR_ENABLE_GUARANTEE      1  /* Task Guarantee enabled */
#define TDSTAR_ENABLE_ALL            1

#define TDSTAR_FAILED_GUARANTEE      8  /* used in the module, unsettabl
                                         in EDF_register_level... */



#define TDSTAR_LEVELNAME        "TDSTAR base"
#define TDSTAR_LEVEL_CODE       166
#define TDSTAR_LEVEL_VERSION    1
